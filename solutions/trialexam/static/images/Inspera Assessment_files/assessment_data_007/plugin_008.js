...
(function() {
  ...
  function init(editor) {
    ...
    editor.document.on('drag',function(event){
      var dragTarget = event.data.getTarget().$;

      if (dragTarget.nodeName.toLowerCase() === 'img') {
        event.stop();
        event.cancel();
    ...
    editable.attachListener( editable, 'scroll', function() {
      resizer.hide();
    });
